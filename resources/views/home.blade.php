                    ...
                    <div class="d-flex flex-row align-items-center">
                        <div class="icon">
                            @if ($employer->profile_pic)
                                <a href="{{ route('company', [$employer->id]) }}"><img src="{{ Storage::url($employer->profile_pic) }}" width="50" alt="Profile Picture"></a>
                            @else
                                <a href="{{ route('company', [$employer->id]) }}"><img src="icons8-amazon-60.png" width="50" alt="Default Profile Picture"></a>
                            @endif
                        </div>
...
<div class="container mt-5">
    <section class="centered-content">
        <p class="lead"><a href="/login"> <button class="btn btn-dark" style="margin-left: -150px;">Sign in</button></a> or Register
            to manage your profile, start applying your jobs.</p>
    </section>
    ...
    <div class="row mt-2 g-1">
        ...
        <div class="col-md-3">
            <div class="card p-2 {{ $job->job_type }}">
                <div class="tex-right"> <small class="badge text-bg-info">{{ $job->job_type }}</small> </div>
                <div class="text-center mt-2 p-3"> <img class="round-circle" width="50" src={{ Storage::url($job->profile->profile_pic) }}" width="100" alt="Profile Image"
...
<footer class="text-white text-center text-lg-start bg-dark">
      ...
      <div class="row mt-4">
        ...
        <div class="col-lg-4 col-md-6 mb-4 mb-md-0">
          ...
          <ul class="fa-ul" style="margin-left: 1.65em;">
            ...
            <li class="mb-3">
              <span class="fa-li"><i class="fas fa-envelope"></i></span><span class="ms-2">info@topjobs.com</span>
            </li>
            <li class="mb-3">
    ...
    <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
      © 2024 Copyright:
      <a class="text-white" href="https://mdbootstrap.com/">Top Jobs</a>
    </div>
    <!-- Copyright -->
  </footer>
<style>
