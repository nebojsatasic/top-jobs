                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="nav-item">
                                <a class="nav-link active" aria-current="page" href="{{ route('job.applied') }}">Applied Jobs</a>
                            </li>
                            <li class="nav-item">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('create.seeker') }}">Job Seeker Registration</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('create.employer') }}">Company Registration</a>
                    </li>
                    @endif
