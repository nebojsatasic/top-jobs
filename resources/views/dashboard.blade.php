						...
						<div class="col-md-4 col-xl-3">
							<div class="card bg-c-yellow order-card">
								<div class="card-block">
									...
									<h2 class="text-right"><i class="fa fa-refresh f-left"></i><span>@if (auth()->user()->plan == 'yearly') $200 @elseif (auth()->user()->plan == 'monthly') $80 @else $20 @endif</span></h2>
									<p class="m-b-0">@if (auth()->user()->plan == 'yearly') Yearly @elseif (auth()->user()->plan == 'monthly') Monthly @else Weekly @endif<span class="f-right"></span>@if (auth()->user()->plan == 'yearly') $200/year @elseif (auth()->user()->plan == 'monthly') $80/month @else $20/week @endif</p>
								</div>
							</div>
						</div>
...
{
    $seekers = $job->users();
    $number = $seekers->count();
    $numberApplicants = $numberApplicants + $number;
}
@endphp
						<div class="col-md-4 col-xl-3">
							<div class="card bg-c-pink order-card">
								<div class="card-block">
									...
									<h2 class="text-right"><i class="fa fa-credit-card f-left"></i><span>{{ $numberApplicants }}</span></h2>
									<p class="m-b-0">Your applicants<span class="f-right">{{ $numberApplicants }}</span></p>
								</div>
							</div>
						</div>
					</div>
